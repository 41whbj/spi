...
class Ui_Application(object):
    def setupUi(self, Application):
        ...
        self.gridLayout_9.addWidget(self.MCU_button_stop, 4, 1, 1, 2)

        self.radioButton_endless = QRadioButton(Application)
        self.radioButton_endless.setObjectName(u"radioButton_endless")
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.radioButton_endless.sizePolicy().hasHeightForWidth())
        self.radioButton_endless.setSizePolicy(sizePolicy4)

        self.gridLayout_9.addWidget(self.radioButton_endless, 2, 2, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.MCU_list_test, 3, 0, 1, 3)

        self.horizontalSpacer_4 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.gridLayout_9.addItem(self.horizontalSpacer_4, 0, 1, 1, 2)
    ...
    def retranslateUi(self, Application):
        ...
        self.radioButton_endless.setText(QCoreApplication.translate("Application", u"\u65e0\u9650\u53d1\u9001", None))
