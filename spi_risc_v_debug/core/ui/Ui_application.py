...
class Ui_Application(object):
    def setupUi(self, Application):
        ...
        self.combo_box_vcc.setMaximumSize(QSize(63, 16777215))
        ...
        self.combo_box_bit.setMaximumSize(QSize(70, 16777215))
        ...
        self.line_test_interval = QLineEdit(Application)
        ...
        self.MCU_line_test.setFont(font2)
        ...
        font3.setBold(False)
        self.label_receive_size.setFont(font3)
        ...
        sizePolicy1.setHeightForWidth(self.button_fold_log.sizePolicy().hasHeightForWidth())
        self.button_fold_log.setSizePolicy(sizePolicy1)
        self.button_fold_log.setMinimumSize(QSize(80, 25))
        ...
        self.gridLayout_2.addWidget(self.button_fold_log, 1, 0, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.log_widget.sizePolicy().hasHeightForWidth())
        self.log_widget.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.text_log.sizePolicy().hasHeightForWidth())
        self.text_log.setSizePolicy(sizePolicy3)
        ...
        self.gridLayout_4.addWidget(self.log_widget, 1, 0, 1, 1)
