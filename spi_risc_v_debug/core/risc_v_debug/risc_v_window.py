...
from .test_thread import SendThread
...
class RiscVWindow(QObject):
    ...
    def start_cycle_send(self):
        ...
        self.send_thread.log_signal.connect(self.application.log_window.log)
        self.send_thread.finished_signal.connect(self.cycle_send_finished)
