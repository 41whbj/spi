...
class Applicaton(QWidget):
    ...
    def __init__(self):
        ...
        self.risc_v_window = RiscVWindow(self, self.spi_controller)
    ...
    def setup_connections(self):
        ...
        # 连接窗口索引变化信号，用于更新按钮状态
        self.ui.stacked_widget.currentChanged.connect(self.update_button_states)
    ...
    def update_button_states(self):
        ...
        if current_index == 0:
            # 当前在PC-FPGA页面，设置FPGA按钮为按下状态（灰色）
            self.ui.button_pc_fpga.setStyleSheet("background-color: #E2E2E2;")  # 灰色
            self.ui.button_pc_mcu.setStyleSheet("")  # 恢复默认样式
        elif current_index == 1:
            # 当前在PC-MCU页面，设置MCU按钮为按下状态（灰色）
            self.ui.button_pc_mcu.setStyleSheet("background-color: #E2E2E2;")  # 灰色
            self.ui.button_pc_fpga.setStyleSheet("")  # 恢复默认样式
