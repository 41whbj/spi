...
class Ui_SubForm_Data(object):
    def setupUi(self, SubForm_Data):
        ...
        self.gridLayout_3.addWidget(self.config, 0, 0, 1, 1)
        ...
        self.line_input_saturation.setMinimumSize(QSize(50, 35))

        self.verticalLayout_3.addWidget(self.line_input_saturation)
        ...
        self.line_input_contrast.setMinimumSize(QSize(0, 35))
        self.line_input_contrast.setMaximumSize(QSize(16777215, 16777215))

        self.verticalLayout_4.addWidget(self.line_input_contrast)
        ...
        self.button_add.setMinimumSize(QSize(0, 50))
        self.button_add.setMaximumSize(QSize(16777215, 16777215))
        self.button_add.setFont(font)

        self.verticalLayout_5.addWidget(self.button_add)
    ...
    def retranslateUi(self, SubForm_Data):
        ...
        self.label_4.setText(QCoreApplication.translate("SubForm_Data", u"\u9971\u548c\u5ea6", None))
        self.label_6.setText(QCoreApplication.translate("SubForm_Data", u"\u5bf9\u6bd4\u5ea6", None))
        self.line_input_contrast.setText("")
