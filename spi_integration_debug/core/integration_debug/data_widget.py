...
class Data_Widget(QWidget):
    ...
    def init_ui(self, show_all, checkable, sendable, add_able=True):
        ...
        self.name_text.setStyleSheet("font-family: SimSun; font-weight: normal; font-size: 14px;")
        ...
        if show_all:
            ...
            self.data_text.setStyleSheet("font-family: Times New Roman; font-size: 14px;")
            ...
            self.data_label.setStyleSheet("font-family: Times New Roman; font-size: 14px;")
